...
//preload sounds but give lots of fetch i think, 27 noon
// import React, { useState, useRef, useEffect } from "react";
// import { QrReader } from "react-qr-reader";
// import { doc, getDoc, updateDoc } from "firebase/firestore";
// import { db } from "./firebase.js";
...
//   const alreadyScannedAudioRef = useRef(new Audio(alreadyScannedSound));
//   const completeAudioRef = useRef(new Audio(complete));
...
//   const triggerVisualFeedback = (color, audioRef) => {
//     setBackgroundColor(color);
//     playSound(audioRef);
//     setTimeout(() => setBackgroundColor("bg-gray-100"), 1000);
//   };
...
//   const handleScanError = (error) => {
//     console.error("QR Scan Error:", error);
//     triggerVisualFeedback("bg-[#FF0000]", errorAudioRef);
//   };
...
//             console.log("Check-in successful");
//             setEmailData({ shouldSend: true, decodedCode, studentName: currentStudentName });
//             triggerVisualFeedback("bg-[#06D001]", successAudioRef);
//             playRandomMessageSound(checkInMessages);
//           } else {
//             console.log("Already checked in for today");
//           }
...
//           triggerVisualFeedback("bg-[#FFCC00]", alreadyScannedAudioRef);
//           lastPlayedRef.current = now;
//         }
//       }
//     }
...
//not sure about this one, bugging latest on 25 night before pass words
// import React, { useState, useRef, useEffect } from "react";
// import { QrReader } from "react-qr-reader";
// import { doc, getDoc, updateDoc } from "firebase/firestore";
// import { db } from "./firebase.js";
